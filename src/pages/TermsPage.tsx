...
const TermsPage = () => {
  return (
    <>
      <SEOHead
        title="Termini e Condizioni di Servizio | Singularity Dream"
            ...
            <div className="backdrop-blur-md bg-background/80 dark:bg-background/60 rounded-2xl shadow-2xl border border-border/50 p-8 md:p-12">
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
                ...
                <section>
                  ...
                  <p className="text-foreground/90 leading-relaxed">
                    Singularity Dream fornisce servizi digitali professionali, tra cui:
                    grafica, sviluppo siti web, video editing, servizi informatici e consulenza.
                    I servizi possono essere aggiornati, ampliati o modificati senza preavviso.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-foreground/90 leading-relaxed">
                    ...
                    È vietato utilizzare il sito per attività fraudolente, diffamatorie o dannose.
                  </p>
                </section>
