        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="glass-card-enhanced p-8 sm:p-12 text-center max-w-4xl mx-auto animate-fade-in scroll-animate">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-6 max-w-3xl mx-auto">
              I guadagni vengono donati direttamente da noi per garantire il massimo impatto.
              Qualsiasi cliente che sceglie Singularity contribuisce attivamente: avrai diritto a ricevere, su richiesta,
              una <strong>mappa dei benefici</strong> e informazioni dettagliate con <strong>video e foto prove</strong>
              che testimoniano esattamente a chi e come vengono destinati i fondi.
            </p>
            <p className="text-base text-muted-foreground mb-8 max-w-2xl mx-auto">
              Il 100% delle donazioni sarà utilizzato esclusivamente per aiutare le persone bisognose e il pianeta,
              garantendo la massima trasparenza e tracciabilità del tuo contributo.
            </p>
